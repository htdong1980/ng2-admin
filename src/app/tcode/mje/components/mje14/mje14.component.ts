...
@Component({
  selector: 'mje-14',
  templateUrl: './mje14.html',
  styleUrls: ['./mje14.scss'],
})

export class Mje14 implements OnInit, OnChanges, OnDestroy {
  id: string;
  tcode: string = 'mje14';
