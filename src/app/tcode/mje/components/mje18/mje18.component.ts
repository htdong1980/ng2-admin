...
@Component({
  selector: 'mje-18',
  templateUrl: './mje18.html',
  styleUrls: ['./mje18.scss'],
})

export class Mje18 implements OnInit, OnChanges, OnDestroy {
  id: string;
  tcode: string = "mje18";
